...
$string['reloadforupdatedinfo'] = 'Recargar para ver información actualizada';
$string['reportvaluemayhavechanged'] = 'El valor del encabezado puede haber cambiado.';
...
$string['rule_section_activity_dates_desc'] = 'Comprueba que cada actividad en las secciones del curso (incluida la sección general) que tiene un par nativo de fechas de inicio y fin tenga ambas fechas definidas. Las actividades con una sola fecha se ignoran. Las secciones ocultas se omiten salvo que se incluyan. Una expresión regular opcional puede limitar la evaluación a las secciones cuyo nombre coincida. Una lista opcional de números ID de categorías de calificación puede limitar la evaluación a las actividades cuyos ítems de calificación estén en esas categorías.';
$string['rule_section_date_label'] = 'El resumen de la sección contiene una etiqueta con fecha';
$string['rule_section_date_label_desc'] = 'Comprueba que el resumen de cada sección del curso (incluida la sección general) contenga una etiqueta literal (sin distinguir mayúsculas) seguida de una fecha interpretable. Son válidas las fechas que PHP strtotime() pueda interpretar y formatos extra fijos en el código como dd/mm/yyyy. Las secciones ocultas se omiten salvo que se incluyan. Una expresión regular opcional puede limitar la evaluación a las secciones cuyo nombre coincida.';
...
$string['ruledatelabel_help'] = 'Texto literal que debe aparecer en el resumen de la sección inmediatamente antes de una fecha interpretable, por ejemplo Inicio: 14/09/2026';
...
$string['rulefailinggradebook_list'] = 'Las siguientes categorías de calificación no cumplen esta comprobación:';
...
$string['rulegradecategoryidnumbers'] = 'Números ID de categorías de calificación';
$string['rulegradecategoryidnumbers_help'] = 'Lista opcional de números ID de categorías de calificación separados por comas (almacenados en el ítem de calificación de cada categoría). Si se indica, solo se evalúan las actividades cuyos ítems de calificación pertenecen directamente a esas categorías. Déjelo vacío para evaluar todas las actividades aplicables.';
...
$string['rulegradecategorymoditems_fail_list'] = 'Las siguientes categorías de calificación no contienen ítems de calificación de actividad:';
...
$string['rulegradeweights_fail_list'] = 'Las siguientes categorías de calificación tienen pesos fuera de la tolerancia aceptada:';
...
$string['rulesectionnameregex'] = 'Expresión regular del nombre de sección';
$string['rulesectionnameregex_help'] = 'Expresión regular de PHP opcional, sin delimitadores. Solo se evalúan las secciones cuyo nombre visible coincida. Déjelo vacío para omitir esta comparación. Ejemplos: cualquier texto que finalice en un número entero, por ejemplo: <b>Unidad 12</b>, usa <b>.*\d+$</b><br>Cualquier texto que inicie numerando, por ejemplo: <b>2. Contexto</b> o <b>2 - Contexto</b>, usa <b>^\d+\s*[.-]\s*.+</b>';
