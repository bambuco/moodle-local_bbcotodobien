...
$string['rule_cm_content_contains_desc'] = 'Comprueba que las actividades de un módulo dado con un número ID dado contengan una cadena literal o una expresión regular en un campo de la tabla del módulo, después de los filtros de formato de Moodle.';
$string['rule_cm_content_excludes'] = 'El contenido de la actividad no contiene texto';
$string['rule_cm_content_excludes_desc'] = 'Comprueba que las actividades de un módulo dado con un número ID dado no contengan una cadena literal o una expresión regular en un campo de la tabla del módulo, después de los filtros de formato de Moodle.';
...
$string['rule_section_activity_dates_desc'] = 'Comprueba que cada actividad en secciones numeradas que tiene un par nativo de fechas de inicio y fin tenga ambas fechas definidas. Las actividades con una sola fecha se ignoran.';
$string['rule_section_date_label'] = 'El resumen de la sección contiene una etiqueta con fecha';
$string['rule_section_date_label_desc'] = 'Comprueba que el resumen de cada sección numerada contenga una etiqueta literal (sin distinguir mayúsculas) seguida de una fecha que PHP strtotime() pueda interpretar.';
...
$string['ruleexcludesections_help'] = 'Números de sección separados por comas que se omitirán. La sección 0 siempre se omite.';
...
$string['rulematchmode_help'] = 'El modo literal busca el texto en la versión de texto plano filtrada del campo, sin distinguir mayúsculas. El modo de expresión regular usa una regex de PHP sin delimitadores.';
...
$string['rulepattern_help'] = 'Texto literal o expresión regular (sin delimitadores) a buscar en el campo filtrado.';
$string['rules'] = 'Reglas';
