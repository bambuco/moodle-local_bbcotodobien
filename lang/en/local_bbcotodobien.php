...
$string['rule_section_activity_dates_desc'] = 'Checks that each activity in course sections (including the general section) that has a native start and end date pair has both dates set. Activities with only one date are ignored. Hidden sections are skipped unless included.';
$string['rule_section_date_label'] = 'Section summary contains a dated label';
$string['rule_section_date_label_desc'] = 'Checks that each course section summary (including the general section) contains a literal label (case-insensitive) followed by a date that PHP strtotime() can parse. Hidden sections are skipped unless included.';
