...
$string['reloadforupdatedinfo'] = 'Reload to see updated information';
$string['reportvaluemayhavechanged'] = 'The heading values may have changed.';
...
$string['rule_cm_content_contains_desc'] = 'Checks that activities of a given module with a given ID number contain a literal string or regular expression in a module table field, after Moodle format conversion (and text filters unless disabled).';
$string['rule_cm_content_excludes'] = 'Activity content does not contain text';
$string['rule_cm_content_excludes_desc'] = 'Checks that activities of a given module with a given ID number do not contain a literal string or regular expression in a module table field, after Moodle format conversion (and text filters unless disabled).';
...
$string['rule_section_activity_dates_desc'] = 'Checks that each activity in course sections (including the general section) that has a native start and end date pair has both dates set. Activities with only one date are ignored. Hidden sections are skipped unless included. An optional regular expression can limit evaluation to sections whose name matches. An optional list of grade category ID numbers can limit evaluation to activities whose grade items sit in those categories.';
$string['rule_section_date_label'] = 'Section summary contains a dated label';
$string['rule_section_date_label_desc'] = 'Checks that each course section summary (including the general section) contains a literal label (case-insensitive) followed by a parseable date. Dates accepted by PHP strtotime() and extra hardcoded formats such as dd/mm/yyyy are valid. Hidden sections are skipped unless included. An optional regular expression can limit evaluation to sections whose name matches.';
...
$string['ruledatelabel_help'] = 'Literal text that must appear in the section summary immediately before a parseable date, for example Start: 14/09/2026';
...
$string['ruleexcludesections_help'] = 'Comma-separated section numbers to skip, including 0 for the general section.';
$string['ruleexportfile'] = 'Rule export file';
$string['rulefailingactivities_list'] = 'The following activities do not meet this check:';
$string['rulefailinggradebook_list'] = 'The following grade categories do not meet this check:';
...
$string['rulegradecategoryidnumbers'] = 'Grade category ID numbers';
$string['rulegradecategoryidnumbers_help'] = 'Optional comma-separated list of grade category ID numbers (stored on each category grade item). When set, only activities whose grade items belong directly to those categories are evaluated. Leave empty to evaluate all applicable activities.';
...
$string['rulegradecategorymoditems_fail_list'] = 'The following grade categories do not contain any activity grade items:';
...
$string['rulegradeweights_fail_list'] = 'The following grade categories have weights outside the accepted tolerance:';
...
$string['ruleincludehiddensections'] = 'Include hidden sections';
$string['ruleincludehiddensections_help'] = 'If enabled, sections with course visibility off (visible = 0) are also evaluated. Availability restrictions are not considered.';
...
$string['rulematchmode_help'] = 'Literal mode looks for the text in the plain-text version of the field (after format conversion, and after text filters unless disabled), ignoring case. Regular expression mode uses a PHP regex without delimiters.';
...
$string['rulepattern_help'] = 'Literal text or regular expression (without delimiters) to look for in the field after format conversion (and after text filters unless disabled).';
$string['rules'] = 'Rules';
...
$string['rulesectionnameregex'] = 'Section name regular expression';
$string['rulesectionnameregex_help'] = 'Optional PHP regular expression without delimiters. Only sections whose visible name matches are evaluated. Leave empty to skip this comparison. Examples: any text ending with an integer, for example Unidad 12, uses .*\d+$; any text that starts with numbering, for example 2. Contexto or 2 - Contexto, uses ^\d+\s*[.-]\s*.+';
$string['rulesfor'] = 'Rules for {$a}';
$string['ruleskipfilters'] = 'Comply without applying filters';
$string['ruleskipfilters_help'] = 'If enabled, Moodle text filters (for example multilang) are not applied before searching. The check uses the stored content after format conversion only.';
