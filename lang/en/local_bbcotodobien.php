...
$string['rule_section_activity_dates_desc'] = 'Checks that each activity in course sections (including the general section) that has a native start and end date pair has both dates set. Activities with only one date are ignored. Hidden sections are skipped unless included. An optional regular expression can limit evaluation to sections whose name matches.';
