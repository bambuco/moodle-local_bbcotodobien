...
/**
 * RF-R01: a matching activity field contains a literal or regular expression.
 *
 * @package    local_bbcotodobien
 * @copyright  2026 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cm_content_contains extends cm_field_rule {
    /**
    ...
    public static function get_name(): string {
        return get_string('rule_cm_content_contains', 'local_bbcotodobien');
    }
    ...
    public static function get_description(): string {
        return get_string('rule_cm_content_contains_desc', 'local_bbcotodobien');
    }
    ...
    /**
     * Check that the plain text contains the pattern.
     *
    ...
    protected function check_field(\stdClass $cm, string $html, string $text, array $params): detail {
        ...
        return $this->make_detail(
            ...
            (int) $cm->id,
            $name,
            $matched ? self::STATUS_PASS : self::STATUS_FAIL,
            $matched ? 'rulecontentcontains_pass' : 'rulecontentcontains_fail'
        );
    }
    ...
    public function render_detail(detail $detail): string {
        ...
        return match ($identifier) {
            ...
            'rulecontentcontains_pass' => get_string('rulecontentcontains_pass', 'local_bbcotodobien'),
            'rulecontentcontains_fail' => get_string('rulecontentcontains_fail', 'local_bbcotodobien'),
