...
/**
 * Event triggered when a full audit type is executed on a course.
 *
 * @package    local_bbcotodobien
 * @copyright  2026 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 ...
 * }
 */
class audit_completed extends \core\event\base {
    /**
     * Initialise required event data properties.
     */
    protected function init(): void {
        $this->data['objecttable'] = 'local_bbcotodobien_course_audit';
        $this->data['crud'] = 'c';
    ...
    public static function get_name(): string {
        return get_string('eventauditcompleted', 'local_bbcotodobien');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' completed audit type '$audittypeid' " .
    ...
    public static function get_objectid_mapping(): array {
        return ['db' => 'local_bbcotodobien_course_audit', 'restore' => \core\event\base::NOT_MAPPED];
    }
